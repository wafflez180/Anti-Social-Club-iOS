...
class HomepageTableViewController: UITableViewController {
    ...
    func createTestPost(){
        ...
        let testPost = Post(id: 0, posterId: 0, message: testMessage, imageSource: "", timestamp: "", voted: false, votedBadge: nil, reported: false, reportCount: 5, commentCount: 3, badgeFunnyCount: 7, badgeDumbCount: 6, badgeLoveCount: 4, badgeAgreeCount: 2, badgeDisagreeCount: 1, isFollowing: true, isPinned: false)
        postsArray+=[testPost!]
